...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/babyformula/V2Ray_ws-tls_bash_onekey/master/install.sh" && chmod +x install.sh && bash install.sh
```
...
证书文件: `/data/v2ray.key 和 /data/v2ray.crt` 请注意证书权限
